            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="logo-hover-zoom img-hover-zoom-translate">
                        <img src="<?php echo get_template_directory_uri() ?>/asset/img/creche1.png" alt="" class="logo-client">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="logo-hover-zoom img-hover-zoom-translate">
                        <img src="<?php echo get_template_directory_uri() ?>/asset/img/toupoutou.png" alt="" class="logo-client">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="logo-hover-zoom img-hover-zoom-translate">
                        <img src="<?php echo get_template_directory_uri() ?>/asset/img/creche3.png" alt="" class="logo-client">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="logo-hover-zoom img-hover-zoom-translate">
                        <img src="<?php echo get_template_directory_uri() ?>/asset/img/creche4.png" alt="" class="logo-client">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="logo-hover-zoom img-hover-zoom-translate">
                        <img src="<?php echo get_template_directory_uri() ?>/asset/img/creche5.png" alt="" class="logo-client">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="logo-hover-zoom img-hover-zoom-translate">
                        <img src="<?php echo get_template_directory_uri() ?>/asset/img/creche6.png" alt="" class="logo-client">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="logo-hover-zoom img-hover-zoom-translate">
                        <img src="<?php echo get_template_directory_uri() ?>/asset/img/creche7.png" alt="" class="logo-client">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="logo-hover-zoom img-hover-zoom-translate">
                        <img src="<?php echo get_template_directory_uri() ?>/asset/img/creche8.png" alt="" class="logo-client">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div id="about-us" class="row">
                <div id="about-us-left" class="col-md-7">
                    ...
                    <a id="supprlink" class="btn btn-outline-dark" role="button" href="http///www.ici-le-lien.fr">En
