<?php
/**
 * Register a custom post type called "lastestnew".
 *
 * @see get_post_type_labels() for label keys.
 */
function wpdocs_codex_lastestnew_init() {
    $labels = array(
        ...
        'not_found'             => __( 'No lastestnews found.', 'mynursery' ),
        'not_found_in_trash'    => __( 'No lastestnews found in Trash.', 'mynursery' ),
        ...
        'insert_into_item'      => _x( 'Insert into lastestnew', 'Overrides the “Insert into post”/”Insert into page” phrase (used when inserting media into a post). Added in 4.4', 'mynursery' ),
        'uploaded_to_this_item' => _x( 'Uploaded to this lastestnew', 'Overrides the “Uploaded to this post”/”Uploaded to this page” phrase (used when viewing media attached to a post). Added in 4.4', 'mynursery' ),
        'filter_items_list'     => _x( 'Filter lastestnews list', 'Screen reader text for the filter links heading on the post type listing screen. Default “Filter posts list”/”Filter pages list”. Added in 4.4', 'mynursery' ),
    ...
    register_post_type( 'lastestnew', $args );
}

add_action( 'init', 'wpdocs_codex_lastestnew_init' );