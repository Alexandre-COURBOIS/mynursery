...
if (!empty($_SESSION)) {
    if (!empty($_SESSION['login']['id']) && is_numeric($_SESSION['login']['id'])) {
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-6">
                    <img class="img_profil" src="<?= get_template_directory_uri() ?>/asset/img/avatar-profil.png"
                    ...
                    <?php if (!empty($creches[0]->supp_rue)) { ?>
                        <p id="margin_profil">Adresse
                            : <?= $creches[0]->num_rue . ' ' . $creches[0]->supp_rue . ' ' . $creches[0]->nom_rue; ?></p>
                    <?php } else { ?>
